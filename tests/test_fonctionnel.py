"""
Unit tests for the Database functions using unittest and unittest.mock.
"""
...
class TestDatabaseFunctions(unittest.TestCase):
    ...
    def test_read_note_from_db(self, mock_connect):
        """Test reading notes from the database."""
        mock_conn = MagicMock()
        mock_cursor = MagicMock()
        mock_connect.return_value = mock_conn
        mock_conn.cursor.return_value = mock_cursor
        mock_cursor.fetchall.return_value = [
            (1, '2025-04-07 20:26:54', 'note')
        ]
    ...
    def test_write_note_into_db(self, mock_connect):
        """Test writing a note into the database."""
        mock_conn = MagicMock()
        mock_cursor = MagicMock()
        mock_connect.return_value = mock_conn
        mock_conn.cursor.return_value = mock_cursor
    ...
    def test_image_upload_record(self, mock_connect):
        """Test recording an image upload into the database."""
        mock_conn = MagicMock()
        mock_cursor = MagicMock()
        mock_connect.return_value = mock_conn
        mock_conn.cursor.return_value = mock_cursor
    ...
    def test_list_images_for_user(self, mock_connect):
        """Test listing images for a user from the database."""
        mock_conn = MagicMock()
        mock_cursor = MagicMock()
        mock_connect.return_value = mock_conn
        mock_conn.cursor.return_value = mock_cursor
        mock_cursor.fetchall.return_value = [
            (1, '2025-04-07 20:26:54', 'name')
        ]
